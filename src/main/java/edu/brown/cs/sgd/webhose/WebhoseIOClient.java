package edu.brown.cs.sgd.webhose;
...
public class WebhoseIOClient {
	...
	public JsonElement getResponse(String rawUrl) throws IOException, URISyntaxException {
		...
		// Set next query URL
		mNext = WEBHOSE_BASE_URL + stripQuotationMarks(o.getAsJsonObject().get("next").toString());
	...
	/**
	   ...
	   *
	   * @param s - the string to strip quotation marks from.
